                ...
                <Responsive
                    xsmall={
                        <div>
                            <div style={styles.flexColumn}>
                                <Button variant="contained" color="primary" className={classes.button} style={{ float :'right', padding: 20, margin: '1em' }} component={Link} to={`/subjectSections`}>
                                     <AddIcon />  
                                     Create timetable
                                    </Button>
                                    <TimetableProcess />
                    ...
                    small={
                      <div>
                        ...
                        <Button variant="contained" color="primary" className={classes.button} style={{ float :'right', margin: '1em' }} component={Link} to={`/subjectSections`}>
                               <AddIcon />  
                               Create timetable
                              </Button>
                        </div>
